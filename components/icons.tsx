...
export const ChatIcon: React.FC<{ className?: string }> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.78 59.78 0 01-5.03 0l-3.722-.537C3.347 17.1 2.5 16.136 2.5 15v-4.286c0-.97.616-1.813 1.5-2.097m16.5 0a2.25 2.25 0 00-2.25-2.25H5.75a2.25 2.25 0 00-2.25 2.25m16.5 0v.006c0 .414-.336.75-.75.75H4.5a.75.75 0 01-.75-.75V8.511" />
  </svg>
);
...
export const TeaLeafIcon: React.FC<{ className?: string }> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const CartIcon: React.FC<{ className?: string }> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l-1.263 12c-.07.658-.463 1.243-1.119 1.243H5.25a1.125 1.125 0 01-1.12-1.243l-1.264-12A1.125 1.125 0 014.125 7.5h15.75c.576 0 1.059.435 1.119 1.007z" />
  </svg>
);
